...
public class LoginTestcase1 {
	...
	/**
	 * Method: To identify a web element using the locators and return a boolean
	 * value.
	 */
	...
	public void doLoginPass() throws IOException {
		...
		wait.until(ExpectedConditions.presenceOfElementLocated(
				By.xpath("//div[@class='AccordionItemcss__StyledAccordionTitle-sc-1cl7j98-1 kJprYL']")));
	...
	/**
	 * Testcase2: To carry out successful logout when the logout button is found and
	 * close the browser once completed.
	 */
	@Test
